    ...
    public sealed class Configuration : DbMigrationsConfiguration<StringDetector.Domain.Entities.EntitiesContext>
    {
        ...
        protected override void Seed(StringDetector.Domain.Entities.EntitiesContext context)
        {
            ...
            context.Jobs.AddOrUpdate(job => job.Key,
                new JobEntity { Key = jobKeys[0], ProjectName = "BugTracker", JobNumber = "000001", SourcePath = "C:\\Dev\\String_Detector\\test_data\\src", Configuration = " SOURCE_DIRECTORIES = ['{here}']", Report = "c:\\testReport.txt" },
                new JobEntity { Key = jobKeys[1], ProjectName = "BugTrackerAdmin", JobNumber = "000002", SourcePath = "C:\\Dev\\String_Detector\\test_data\\src", Configuration = " SOURCE_DIRECTORIES = ['{here}']", Report = "basepath\\Report\\BugTrackerAdmin\\" }
                );
