...
using Custom.System.Web.Http;
using Custom.System.Web.Http.Internal;
using Custom.System.Web.Http.Routing;
using Custom.System.Web.Http.Controllers;
using Custom.System.Collections.Generic;
...
using StringDetector.API.Properties;
    ...
    public class CustomApiControllerActionSelector : IHttpActionSelector
    {
        ...
        private class ActionSelectorCacheItem
        {
            ...
            private HttpResponseMessage CreateActionNotFoundResponse(HttpControllerContext controllerContext)
            {
                ...
                return controllerContext.Request.CreateErrorResponse(HttpStatusCode.NotFound, Error.Format(SRResources.ResourceNotFound, controllerContext.Request.RequestUri) +Error.Format(SRResources.ApiControllerActionSelector_ActionNotFound, _controllerDescriptor.ControllerName));
            }
            ...
            {
                return controllerContext.Request.CreateErrorResponse(HttpStatusCode.NotFound, Error.Format(SRResources.ResourceNotFound, controllerContext.Request.RequestUri) + Error.Format(SRResources.ApiControllerActionSelector_ActionNameNotFound, _controllerDescriptor.ControllerName, actionName));
            }
