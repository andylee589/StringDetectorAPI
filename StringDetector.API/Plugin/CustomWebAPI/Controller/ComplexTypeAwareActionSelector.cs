...
namespace WebApiDoodle.Web.Controllers
{
    ...
    /// We optimize for the case where we have an <see cref="SelfComplexTypeAwareActionSelector"/> instance per <see cref="HttpControllerDescriptor"/>
    ...
    /// <see cref="SelfComplexTypeAwareActionSelector"/> as well. In the latter case the lookup is slightly slower because it goes through
    /// the <see cref="P:System.Web.Http.Controllers.HttpControllerDescriptor.Properties"/> dictionary.
    /// </summary>
    /// <remarks>Most of the code has been taken from <see cref="System.Web.Http.Controllers.CustomComplexTypeAwareActionSelector"/>.</remarks>
    public class SelfComplexTypeAwareActionSelector : IHttpActionSelector
    {
